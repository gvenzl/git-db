...
SCRIPT_FILES="database/__init__.py database/oracle.py git_db_add.py git_db_commit.py git_db_configuration.py git_db_deinit.py git_db_init.py git_db_status.py git_db_utils.py"
DB_TYPE="oracle"
